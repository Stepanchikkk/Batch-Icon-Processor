export const Upload = ({ size = 24, className = '' }: { size?: number; className?: string }) => (
...
export const Settings = ({ size = 24, className = '' }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M12 1v6m0 6v6m0-18l-2.5 2.5M12 1l2.5 2.5M12 23l-2.5-2.5M12 23l2.5-2.5m3.5-8.5h6m-6 0l2.5-2.5m-2.5 2.5l2.5 2.5M1 12h6m-6 0l2.5-2.5M1 12l2.5 2.5" />
  </svg>
);
